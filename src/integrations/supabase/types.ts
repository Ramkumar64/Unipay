...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      transactions: {
        Row: {
          ...
          converted_currency: Database["public"]["Enums"]["currency_code"]
          created_at: string
    ...
    Functions: {
      process_transaction: {
        Args: {
          ...
          p_original_currency: Database["public"]["Enums"]["currency_code"]
          p_pin: string
      ...
      set_user_pin: { Args: { p_pin: string }; Returns: undefined }
      verify_user_pin: {
    ...
    Enums: {
      ...
      txn_type: "SEND" | "DEPOSIT" | "WITHDRAW"
    }
    CompositeTypes: {
      [_ in never]: never
    }
